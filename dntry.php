...
<nav>
        <ul>
          <li><a href="home.php">Home</a> </li>
            ...
            <li><a href="register.php">Volunteer</a> </li>
...
<input type = "text" name="activity" id="activity"  required>
 <br>
  ...
  <option value="100" name="service" id="Visiting" >Visiting</option>
  <option value="200" name="service" id="Coaching" >Coaching</option>
  <option value="500" name="service" id="Publishing" >Publishing</option>
  <option value="150" name="service" id="Tuition" >Tuition</option>
  <option value="150" name="service" id="Child care" >Child care</option>
  <option value="250" name="service" id="Recreation Activities" >Recreation Activities</option>
  <option value="600" name="service" id="Medical Care" >Medical Care</option>
</select></td>
    </tr>    
 ...
 <input type="checkbox" name="apref" value="children" >Children
              <input type="checkbox" value="identity" value="youth" >Youth
...
$avail=$_GET["avail"];     
$msg=$_GET["msg"];     
        echo "print inside button click";
      ...
      if(!$conn){
         ...
         $insquery="INSERT INTO demo VALUES('$fname','$gender','$dob','$phno','$eid','$edu','$dis','$train','$exp','$activity','$identity','$serv','$apref','$avail','$msg')";
