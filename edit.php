...
<nav>
  ...
  <section class="loginbox"> 
    <img src="avatar.png" class="avatar" >
        <h1 style="margin-left: 100px">Update Events</h1>
        <form method="GET" novalidate>
    <table cellspacing="10" class="tstyle" >

             
        <tr><td style="color: white;font-size: 15px;font-family:cursive">Event Name</td>
    <td><input type="textarea" name="nid" id="nid" required>
            <br>
        ...
        <td colspan="2" align="center">
            <input type="submit" name="fetchbtn" value="UPLOAD" id="fetchbtn" class="btnstyle">
            </td></tr>
            <tr><td style="color: white;font-size: 15px;font-family:cursive">Event ID</td>
    <td><input type="text" name="evnid" id="evnid" required>
            <br>
        ...
        <tr>
        <td colspan="2" align="center">
            <input type="submit" name="fetchbtn2" value="DELETE EVENTS" id="fetchbtn2" class="btnstyle">
            </td></tr>
        
         <tr>
        <td colspan="2" align="center">
            <input type="submit" name="fetchbtn3" value="VIEW EVENTS" id="fetchbtn3" class="btnstyle">
            </td></tr>
        ...
        function validate()
        {
            ...
            if(nid.checkValidity)
                {
                    document.getElementById("err2").innerHTML=nid.validationMessage;
...
$ename=$_GET["nid"];   
      ...
      if(!$conn){
         ...
         $insquery="INSERT INTO events(event_NAME) VALUES('$ename')";
    ...
    if(!$conn)
{
 ...
 $evnid=$_GET["evnid"];
    ...
    $query="delete from events where event_ID = '$evnid' ";
    $res=mysqli_query($conn,$query);
    $rd = mysqli_affected_rows($conn);
        if($rd > 0){
    ...
    if(!$conn)
{
    ...
    if($res=mysqli_query($conn,$query)){
        ...
        echo "<table border =2 class=tstyle2>";
         echo "<tr>";   
        echo "<th colspan=6>List of Upcoming Events</th>";
            echo "</tr>";
        echo "<tr>";
        echo "<th>EVENT-ID </th>";
