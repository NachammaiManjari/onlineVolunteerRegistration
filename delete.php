...
<nav>
  ...
  <section class="loginbox"> 
    <img src="avatar.png" class="avatar" >
        <h1 style="margin-left: 100px">Delete Here</h1>
        <form method="GET" novalidate>
    <table cellspacing="10" class="tstyle" >

        
        <tr><td style="color: white;font-size: 15px;font-family:cursive">Experience</td>
    <td><input type="text" name="eid" id="eid" required>
        ...
        <td colspan="2" align="center">
            <input type="submit" name="fetchbtn" value="DELETE" id="fetchbtn" class="btnstyle">
            </td></tr>
        
        <tr>
        <td colspan="2" align="center">
            <input type="submit" name="fetchbtn2" value="DELETE ALL" id="fetchbtn2" class="btnstyle">
            </td></tr>
    ...
    if(!$conn)
{
 ...
 $exp=$_GET["eid"];
    ...
    $query="delete from demo where experience = '$exp' ";
