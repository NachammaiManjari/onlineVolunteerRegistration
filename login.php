...
<nav>
    ...
    <table cellspacing="10" class="tstyle" >
        ...
        <tr><td style="color: white;font-size: 15px;font-family:cursive">Email Id</td>
...
<tr><td style="color: white;font-size: 15px;font-family:cursive">Password</td>
    ...
    <br>
        ...
        <td colspan="2" align="center">
            <input type="submit" name="loginsubmit" value="LOGIN" id="loginbtn" class="btnstyle">
            </td></tr>
    </table>
            ...
            if(eid.checkValidity)
                {
                    ...
                    if(eid.validationMessage.toString().length!=0)
                        check=0;
                }
            ...
            if(psw.checkValidity)
                {
                    ...
                    if(psw.validationMessage.toString().length!=0)
                        check=0;
                }
           if(check == 0)
               {
