...
<nav>
  ...
  <section class="loginbox"> 
    <img src="avatar.png" class="avatar" >
        <h1 style="margin-left: 100px">Upload Service</h1>
        <form method="GET" novalidate>
    <table cellspacing="10" class="tstyle" >

             
        <tr><td style="color: white;font-size: 15px;font-family:cursive">Enter Service Name</td>
    <td><input type="text" name="sid" id="sid" required>
            <br>
            <span id="err" style="color:#ffcc33 ;font-style: italic"></span>
            </td></tr>
...
$s=$_GET["sid"];   
      ...
      if(!$conn){
         ...
         $insquery="INSERT INTO service(service_NAME) VALUES('$s')";
    ...
    if(!$conn)
{
    ...
    if($res=mysqli_query($conn,$query)){
        ...
        echo "<table border =2 class=tstyle2>";
         echo "<tr>";   
        echo "<th colspan=6>Volunteer Services List</th>";
            echo "</tr>";
        echo "<tr>";
